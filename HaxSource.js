javascript: function ultraclick() {
...
const addCookiesAction = createAction(
	"Add Cookies",
	"Instantly adds x amount of cookies",
	() => {
...
const addLumpsAction = createAction(
	"Add Sugar Lumps",
	"Instantly adds x amount of sugar lumps",
	() => {
...
const addUnitsAction = createAction(
	"Add Units",
	"Instantly adds x amount of y units",
	() => {
...
const toggleultraclickEnabledAction = createAction(
	"Ultraclick",
	"When enabled, makes each click add 10^20 cookies",
	() => {
...
const unlockAction = createAction(
	"Unlock Achievement",
	"Instantly unlocks the achievement named x",
	() => {
		Game.Win(unlockField.value);
	}
);
const addChipsField = createField("number", "A Number");
const addChipsAction = createAction(
	"Add Heavenly Chips",
	"Instantly gives you x amount of heavenly chips",
	() => {
...
var autoclickerID = -1;
const toggleAutoAction = createAction(
	"Autoclicker",
	"Enables an autoclicker on the big cookie (doesn't require that your mouse is on the big cookie)",
	() => {
...
const spawnGoldenAction = createAction(
	"Spawn Golden Cookie",
...
var goldenID = -1;
const toggleGoldenAction = createAction(
	"Gold Farm",
	"Automatically clicks on golden cookies",
	() => {
...
var upgradeID = -1;
const toggleUpgradeAction = createAction(
	"Auto Upgrade",
	"Automatically buys available upgrades",
	() => {
...
const changeTextureAction = createAction(
	"Retexture",
	"Changes the texture of the provided texture to the image from the provided URL",
	() => {
		Game.Loader.Replace(
			changeTextureFromField.value,
			changeTextureToField.value
		);
	}
);
...
const autoUpgradeUnitAction = createAction(
	"Auto Upgrade Units",
	"Automatically upgrades your units with sugar lumps",
	() => {
...
const spawnWrinklerAction = createAction(
	"Spawn Wrinkler",
	"Spawns a wrinkler",
	() => {
		Game.SpawnWrinkler();
...
const unlockUpgradeAction = createAction(
	"Unlock Upgrade",
	"Unlocks the provided upgrade",
	() => {
		Game.Unlock(unlockUpgradeField.value);
	}
);
const unlockAllUpgradesAction = createAction(
	"Unlock All Upgrades",
...
const buffAction = createAction("Add Buff", "Adds a buff", () => {
	Game.gainBuff(
		buffName.value,
		parseInt(buffTime.value),
		parseInt(buffArg1.value)
	);
});
const clearBuffAction = createAction(
	"Clear Buffs",
...
const farmWrinklersAction = createAction(
	"Auto Pop Wrinklers",
	"Automatically pops wrinklers after 2 minutes",
	() => {
...
const unlockAllAchievementsAction = createAction(
	"Unlock All Achievements",
	"Unlocks all achievements (doesn't unlock shadow achievements)",
	() => {
